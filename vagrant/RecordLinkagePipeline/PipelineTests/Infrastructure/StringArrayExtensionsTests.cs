...
namespace Pipeline.UnitTests
{
    ...
    public class StringArrayExtensionsTests
    {
        ...
        {
            var results = new[] { "a", "b", "c", "d" }.CreateNGrams(4);
        ...
        {
            var results = new[] { "a", "b", "c", "d" }.CreateNGrams(1, 4);
        ...
        {
            var results = new[] { "ant", "bee", "cat" }.CreateUniBiTokenShingles();
        ...
        {
            var results = new[] { "ant" }.CreateBiTriTokenShingles();
        ...
        {
            var results = new[] { "ant", "bee" }.CreateBiTriTokenShingles();
